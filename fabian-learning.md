...
- **China may limit access to top AI models** (AI x gaming). Bill Bishop's July 7 issue flags a possible PRC move to restrict access to leading AI models, and the question mark is Bishop's own, the issue is largely paywalled so treat it as framing. It sits in a pattern though: his July 1 issue already flagged new AI model regulation. If access to frontier models becomes policy-managed in China, that shapes what Chinese studios and partners can build with, which touches everything from Tencent's AI plans to the tooling behind the games on our stages. [Sinocism](https://sinocism.com/p/floods-and-xis-instructions-prc-to)
- **"Eastern Data, Western Compute" gets called fake** (leadership & negotiation). ChinaTalk investigated China's flagship plan to route AI data-center buildout away from the crowded eastern seaboard to interior hubs like Guizhou, where land, energy, and cooler climates are cheap. Their finding: the neat national-compute-grid story does not survive contact with reality, and much of the initiative runs far below the billing. Useful skepticism to keep on hand for every state-led megaproject narrative, where the slide deck and the ground truth can live years apart. [ChinaTalk](https://www.chinatalk.media/p/eastern-data-western-compute-is-fake)
- **France's gambling regulator says all esports betting is illegal, mid-EWC** (gaming & esports industry). The ANJ warning landed July 9, right in our Paris window, and it declares betting on esports outcomes illegal in the host market of the world's biggest esports event. Betting brands and odds content are woven deep into esports sponsorship, so an explicit illegality statement creates real compliance questions for teams, partners, and on-site activations while we run. One for the compliance and partnerships side to have on the radar while the event runs. [Esports.net](https://www.esports.net/news/france-says-esports-betting-illegal-at-esports-world-cup/)
...
- **Xbox set a 77M Game Pass target for 2026 and sits below half of it** (gaming & esports industry). Gies W27 pairs the 3,200 job cuts and 5-studio divestment with the number sitting underneath them: the subscription bet that justified the whole platform strategy missed its central target by more than half. That makes the cuts read as consequence of a missed bet, and it's the cleanest single stat yet for the two-clocks read from Monday: business-model bets get graded fast, game portfolios pay the bill slowly. [Gies weekly](https://giesweekly.substack.com/p/xbox-cuts-3200-jobs-and-divests-five)
- **Stillfront CEO Alexis Bonte steps down** (gaming & esports industry). Mobile Gaming Today #114 flags the change, he stays on until a successor is appointed. Stillfront is one of the big mobile roll-ups, a portfolio of acquired studios, so a leadership reset there is a data point on how the acquisition-driven mobile model is holding up in a market where UA costs keep climbing. Worth watching who they pick: an operator would signal consolidation mode, a dealmaker would signal more buying. [Mobile Gaming Today](https://gamigion.substack.com/p/mobile-gaming-today-114)
- **EFG bans skin-trading and skin-gambling sponsors from CS2 events** (gaming & esports industry). Any company that touches a player's Valve inventory is now out as a team sponsor at EFG tournaments, across logos, broadcasts, and partnership deals, following Valve's own December restriction. Skin sites have been one of the most visible sponsor categories in Counter-Strike, so a chunk of club revenue in our biggest shooter scene disappears with one rulebook update, which tightens the club economics we already watch closely. And since EFG runs our events, the policy line sits exactly one step from EWC's own broadcast standards. [The Esports Radar](https://esportsradar.gg/esl-officially-bans-skin-trading-and-gambling-sites-as-team-sponsors-in-cs2-tournaments/)
...
The 2026 event playbook reads less like a LAN tournament and more like a music festival. Arenas now run 8K main LED walls with 4K side screens for each team's point of view, AR overlays that paint live stats and sponsor moments onto the stage, and lighting rigs that flash with the action. Evo 2026 in Las Vegas is staged as a three-day carnival: 12 tournaments, a 300-cabinet arcade, artist spaces, cosplay, meet-and-greets. The Riyadh EWC already turned food and drink into themed zones built around game universes. The throughline is that events now compete for the same Saturday night as concerts and streaming premieres.

Why this matters for EF: this is the EWC Paris brief in a sentence. Paris Expo Porte de Versailles, Jul 6 to Aug 23, 25 tournaments, seven straight weeks, in the same halls that ran Paris 2024. The bar for spectacle keeps rising, and the venue choice signals you are playing at that level.

Here is the tension worth holding. You privately think the production-heavy model is miscalibrated, since 45-55% of EWC viewership comes from co-streamers rather than the broadcast, and publishers will not let tournament organizers run their IP at low production values. So the real question is which parts of the spectacle convert the on-site crowd into the at-home millions.

One question to chew on: of all the Paris production spend, which single element earns its keep in the co-stream clips the next morning, and which is just for the room?

### 2. Dalio's test for leaders: get good at what you don't know (leadership & negotiation)

In a January 2026 HBR podcast, Ray Dalio gave senior leaders a line worth pinning up: know what you know, know what you don't know, and treat handling the unknown as more important than anything you already know. It sits on top of his older engine, an idea meritocracy run on radical transparency and what he calls thoughtful disagreement, where conflict is fuel for better decisions instead of a threat.

Why this matters for you: this is the Culture Code vulnerability loop in a banker's vocabulary. Your own rule already says flag uncertainty rather than invent a tidy thesis (the China-fandom example). Dalio raises the bar from "admit the gap" to "build a process for the gap." For the Games team redesign, that is the difference between you carrying every call and a structure where Morten and Jan can disagree with you in the open and the best idea wins.

One question to chew on: where are you still the single point of judgment on a Games decision, and what would it take to hand that to a thoughtful-disagreement process your directors own?

#### News of the day

- **Evo 2026 becomes a three-day Las Vegas carnival** (live events & immersive). The fighting-game finals now wrap 12 tournaments, a 300-cabinet arcade, artist spaces and cosplay into one production, more theme park than bracket. [CGMagazine](https://www.cgmagonline.com/articles/competitive-gaming-events-bigger-2026)
- **GDC 2026: 94% of developers report at least one burnout symptom** (gaming & esports industry). The same report driving the AI debate also flags a workforce running hot, a real constraint on any studio betting on faster output. [GDC](https://gdconf.com/article/gdc-2026-state-of-the-game-industry-reveals-impact-of-layoffs-generative-ai-and-more/)
- **Dubai Esports & Games Festival resets its dates and widens fan experiences** (live events & immersive). The Gulf's consumer-facing festival is leaning harder into fan zones and activations, a useful read on regional appetite next door to KSA. [Campaign Middle East](https://campaignme.com/dubai-esports-games-festival-reveals-new-dates-with-expanded-fan-experiences/)

**Sources (Edition #2)**

- Ray Dalio on decisions amid uncertainty, HBR podcast, Jan 2026: https://hbr.org/podcast/2026/01/ray-dalio-on-economic-trends-investing-and-making-decisions-amid-uncertainty
- The next generation esports fan experience, via SportsTravel: https://www.sportstravelmagazine.com/the-next-generation-esports-fan-experience-beyond-the-screen/
- Competitive gaming events are becoming bigger productions in 2026, via CGMagazine: https://www.cgmagonline.com/articles/competitive-gaming-events-bigger-2026
- EWC 2026 Paris venue confirmed, tickets live, via Esports World Cup: https://esportsworldcup.com/en/press-releases/ewc-2026-paris-confirmed-for-paris-expo-porte-de-versailles-tickets-live-from-may-29
- GDC 2026 State of the Game Industry, via GDC: https://gdconf.com/article/gdc-2026-state-of-the-game-industry-reveals-impact-of-layoffs-generative-ai-and-more/

---

## 2026-06-02 (Edition #1)

### 1. The AI mandate and the people who have to use it are pulling apart (AI x gaming)

The GDC 2026 trends report just landed, and the headline is a split screen. On one side, AI assistive tools have gotten good enough that most developers can use them without much friction, and 78% of game companies now have a formal AI policy on the books. On the other side, 52% of developers say generative AI is actively harming their industry, up from 30% a year ago. Adoption is climbing and resentment is climbing at the same time.

A few details worth keeping. The enthusiasm clusters around planning and routine work: bug triage, boilerplate code, first-line player support. "Agentic AI" is being pitched as the way to take a bite out of ballooning AAA budgets. The skepticism clusters around the creative core, the people who feel the tool is being aimed at their craft rather than their chores. The report also flags an "infrastructure problem": a lot of companies bought the mandate before they built the plumbing to use it well.

Why this matters for you: Ralf is pushing AI-first at the Foundation, scaling impact without scaling headcount. This data is the early-warning map for that move. The easy wins live in the boring layer (negotiation prep, contract redlines, publisher research, the newsletter-crawling idea you floated to Ralf in February). The friction shows up the moment people read a mandate as "the tool is coming for the part of my job I'm proud of." Sequencing and framing decide which of those two curves you ride.
...
This is the public version of something you already hold privately. Single-game orgs that live or die on one star (your T1-is-Faker point) look fragile under this lens. Multi-game aggregators that build durable cross-community businesses (your Vitality example) look strong. The market is slowly arriving at the thesis your EWC Club Championship structure was built to reward.
...
- GDC 2026 Festival of Gaming trends report, via GamesBeat: https://gamesbeat.com/gdc-festival-of-gaming-2026-trends-report-casts-light-on-genai-co-dev-advocacy-game-publishing-and-finance/
- GDC 2026 trends, generative AI "infrastructure problem", via GameDev.net: https://gamedev.net/news/gdc-trends-report-2026-as-use-of-generative-ai-rises-devs-face-infrastructure-problem-r3601/
- GDC 2026 State of the Game Industry, via GDC: https://gdconf.com/article/gdc-2026-state-of-the-game-industry-reveals-impact-of-layoffs-generative-ai-and-more/
- Esports business strategies, deals and transformations, Q1 2026, via Esports Charts: https://escharts.com/news/business-strategies-deals-and-transformations-esports-industry-q1-2026
- Esports trends 2026, industry figures, via Esports Charts: https://escharts.com/news/esports-trends-2026-industry-figures-insights
